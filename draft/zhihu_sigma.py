...
class Monitor(object):
   ...
   """
    ...
    def main(self):
        """
        Get the details and data of the question
        """
        soup = self.soup
        ...
        self.dict['visitor_num'] = visitor_number
        ...
        self.dict['topic_follower_num'] = topic_follower_number
        ...
        if soup.find('div', class_ = 'zh-question-followers-sidebar').get_text() != '还没有人关注该问题':
            ...
            self.dict['follower_num'] = follower_number
            ...
            for i in xrange((follower_number - 1)/20 + 1):
                if i == 0:
                    ...
                    follower_more_soup = BeautifulSoup(follower_lists)
                    if follower_more_soup.find_all('div', class_ = 'details zg-gray') != None:
                        user_detail_docs = follower_more_soup.find_all('div', class_ = 'details zg-gray')
                        for user_detail_doc in user_detail_docs:
                            follower_doc = user_detail_doc.find('a').string
                            # print follower_doc.string
                            follower_number = int(filter(lambda x: x.isdigit(), follower_doc))
            ...
            self.dict['follower_follower'] = total_count
        ...
        self.dict['answer_num'] = answer_number
        self.dict['followers_answerer'] = total_follower_number_answerer
        self.dict['comment_num'] = total_comment_number
        self.dict['upvote_num'] = total_upvote
        self.dict['follower_follower'] = total_count
...
class Collector(object):
    ...
    def __init__(self):
        """
        inits parameters: including initial url, header, and _xsrf
        """
    ...
    def main(self):
        """
        Collect questions and store them into json file
        """
        soup = self.soup
        question_poll = []
